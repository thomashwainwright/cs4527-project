      ...
      prev.map((item) =>
        item.assignment_id === assignment.assignment_id
          ? {
              ...item,
              custom_formula: text,
              hours: evaluateFormula(assignment, text),
              focused: false,
              edit: true,
            }
          : item,
  ...
  const columns = [
    {
      key: "alpha",
      label: "Alpha",
      render: (a: CombinedAssignmentType) => a.alpha,
    },
    {
      key: "beta",
      label: "Beta",
      render: (a: CombinedAssignmentType) => a.beta,
    },
    {
      key: "delta",
      label: "Delta",
      render: (a: CombinedAssignmentType) => a.delta,
    },
    {
      key: "share",
      label: "Share",
      render: (a: CombinedAssignmentType) => a.share,
    },
    {
      key: "credits",
      label: "Credits",
      render: (a: CombinedAssignmentType) => a.credits,
    },
    {
      key: "students",
      label: "Students",
      render: (a: CombinedAssignmentType) => a.estimated_number_students,
    },
    {
      key: "students_groups",
      label: "Students/Number of Groups",
      render: (a: CombinedAssignmentType) => a.estimated_number_students,
    },
    {
      key: "coordinator",
      label: "Coordinator",
      render: (a: CombinedAssignmentType) =>
        a.coordinator ? "Yes (15)" : "No (0)",
    },
    {
      key: "hours",
      label: "Hours",
      render: (a: CombinedAssignmentType) => a.hours,
    },
    {
      key: "crit",
      label: "Crit",
      render: (a: CombinedAssignmentType) => a.crit,
    },
                ...
                .map((assignment: CombinedAssignmentType) => (
                  ...
                  >
                    ...
                    <td
                      className={
                        "px-4 py-2 border " +
                        (!assignment.focused && assignment.hours == "ERROR"
                          ? "bg-red-200"
                          : "")
                      }
                      contentEditable
